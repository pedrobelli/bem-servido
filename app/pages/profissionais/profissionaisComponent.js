define(['ko', 'text!profissionaisTemplate', 'bridge', 'jquery', 'swalComponent', '../shared/search/searchComponent'],
function(ko, template, bridge, $, swalComponent, searchComponent) {

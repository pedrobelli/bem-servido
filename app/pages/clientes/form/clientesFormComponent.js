define(['ko', 'text!clientesFormTemplate', 'bridge', 'jquery', 'materialize', 'maskComponentForm', 'swalComponentForm'],
function(ko, template, bridge, $, materialize, maskComponent, swalComponent) {
